...
VALUES
    ('https://wzdbqcgtygvmtfdajvio.supabase.co/storage/v1/object/public/CinemaAppPhotos/vsfcbekllchxbgylfrta/images/movies/Avatar/4pNlHx6ytdYBDs94PgcS0wQkbc4.jpg', false,
     (SELECT id FROM movies WHERE title = 'Avatar: The Way of Water')),
    ('https://wzdbqcgtygvmtfdajvio.supabase.co/storage/v1/object/public/CinemaAppPhotos/vsfcbekllchxbgylfrta/images/movies/Avatar/rZAUAePCueGzTdDzRQe9wD8x1Ov.jpg', false,
     (SELECT id FROM movies WHERE title = 'Avatar: The Way of Water')),
    ('https://wzdbqcgtygvmtfdajvio.supabase.co/storage/v1/object/public/CinemaAppPhotos/vsfcbekllchxbgylfrta/images/movies/Avatar/s16H6tpK2utvwDtzZ8Qy4qm5Emw.jpg', false,
     (SELECT id FROM movies WHERE title = 'Avatar: The Way of Water')),

    ('https://wzdbqcgtygvmtfdajvio.supabase.co/storage/v1/object/public/CinemaAppPhotos/vsfcbekllchxbgylfrta/images/movies/Mickey17/2S3hRv6KqoZ3vReqlTVk1aHJIU6.jpg', false,
     (SELECT id FROM movies WHERE title = 'Mickey 17')),
    ('https://wzdbqcgtygvmtfdajvio.supabase.co/storage/v1/object/public/CinemaAppPhotos/vsfcbekllchxbgylfrta/images/movies/Mickey17/7Oh1xRB8QbMduhqXEUHKlnwxMJi.jpg', false,
     (SELECT id FROM movies WHERE title = 'Mickey 17')),
    ('https://wzdbqcgtygvmtfdajvio.supabase.co/storage/v1/object/public/CinemaAppPhotos/vsfcbekllchxbgylfrta/images/movies/Mickey17/cyDndCTSLg6GGVvDQLsaV4fXJzC.jpg', false,
     (SELECT id FROM movies WHERE title = 'Mickey 17')),
    ('https://wzdbqcgtygvmtfdajvio.supabase.co/storage/v1/object/public/CinemaAppPhotos/vsfcbekllchxbgylfrta/images/movies/Mickey17/qUc0Hol3eP74dbW4YyqT6oRLYgT.jpg', false,
     (SELECT id FROM movies WHERE title = 'Mickey 17')),

    ('https://wzdbqcgtygvmtfdajvio.supabase.co/storage/v1/object/public/CinemaAppPhotos/vsfcbekllchxbgylfrta/images/movies/Oppenheimer/8szKvTWhqnatqrHWloFyyPX1WZc.jpg', false,
     (SELECT id FROM movies WHERE title = 'Oppenheimer')),
    ('https://wzdbqcgtygvmtfdajvio.supabase.co/storage/v1/object/public/CinemaAppPhotos/vsfcbekllchxbgylfrta/images/movies/Oppenheimer/h0TuquPlfxqe4sJSy7sUlEzaAsL.jpg', false,
     (SELECT id FROM movies WHERE title = 'Oppenheimer')),
    ('https://wzdbqcgtygvmtfdajvio.supabase.co/storage/v1/object/public/CinemaAppPhotos/vsfcbekllchxbgylfrta/images/movies/Oppenheimer/kMa1TSDj76zTSleXE7xsuZ4s3i0.jpg', false,
     (SELECT id FROM movies WHERE title = 'Oppenheimer')),
    ('https://wzdbqcgtygvmtfdajvio.supabase.co/storage/v1/object/public/CinemaAppPhotos/vsfcbekllchxbgylfrta/images/movies/Oppenheimer/ycnO0cjsAROSGJKuMODgRtWsHQw.jpg', false,
     (SELECT id FROM movies WHERE title = 'Oppenheimer')),

    ('https://wzdbqcgtygvmtfdajvio.supabase.co/storage/v1/object/public/CinemaAppPhotos/vsfcbekllchxbgylfrta/images/movies/Interstellar/5C3RriLKkIAQtQMx85JLtu4rVI2.jpg', false,
     (SELECT id FROM movies WHERE title = 'Interstellar')),
    ('https://wzdbqcgtygvmtfdajvio.supabase.co/storage/v1/object/public/CinemaAppPhotos/vsfcbekllchxbgylfrta/images/movies/Interstellar/l33oR0mnvf20avWyIMxW02EtQxn.jpg', false,
     (SELECT id FROM movies WHERE title = 'Interstellar')),
    ('https://wzdbqcgtygvmtfdajvio.supabase.co/storage/v1/object/public/CinemaAppPhotos/vsfcbekllchxbgylfrta/images/movies/Interstellar/l38yk8r3RLzLYgFFvRYcOiDbvcq.jpg', false,
     (SELECT id FROM movies WHERE title = 'Interstellar')),
    ('https://wzdbqcgtygvmtfdajvio.supabase.co/storage/v1/object/public/CinemaAppPhotos/vsfcbekllchxbgylfrta/images/movies/Interstellar/ln2Gre4IYRhpjuGVybbtaF4CLo5.jpg', false,
     (SELECT id FROM movies WHERE title = 'Interstellar')),

    ('https://wzdbqcgtygvmtfdajvio.supabase.co/storage/v1/object/public/CinemaAppPhotos/vsfcbekllchxbgylfrta/images/movies/BlackPearl/16FT0cxxBK9qQSvZf7F8i0ITQPm.jpg', false,
     (SELECT id FROM movies WHERE title = 'Pirates of the Caribbean: The Curse of the Black Pearl')),
    ('https://wzdbqcgtygvmtfdajvio.supabase.co/storage/v1/object/public/CinemaAppPhotos/vsfcbekllchxbgylfrta/images/movies/BlackPearl/dm0Q0RtV6U8pgM0mXvsNJpwRayP.jpg', false,
     (SELECT id FROM movies WHERE title = 'Pirates of the Caribbean: The Curse of the Black Pearl')),
    ('https://wzdbqcgtygvmtfdajvio.supabase.co/storage/v1/object/public/CinemaAppPhotos/vsfcbekllchxbgylfrta/images/movies/BlackPearl/nr6SuKESwEPZnExvxSzQczF1iBt.jpg', false,
     (SELECT id FROM movies WHERE title = 'Pirates of the Caribbean: The Curse of the Black Pearl')),
    ('https://wzdbqcgtygvmtfdajvio.supabase.co/storage/v1/object/public/CinemaAppPhotos/vsfcbekllchxbgylfrta/images/movies/BlackPearl/tDNHCZpTaLhVF7awv1PYgDkvHJU.jpg', false,
     (SELECT id FROM movies WHERE title = 'Pirates of the Caribbean: The Curse of the Black Pearl')),

    ('https://wzdbqcgtygvmtfdajvio.supabase.co/storage/v1/object/public/CinemaAppPhotos/vsfcbekllchxbgylfrta/images/movies/OnceUpon/ltUKAxoQ4GRu7EaUNg8GxD9vZ6u.jpg', false,
     (SELECT id FROM movies WHERE title = 'Once Upon a Time... in Hollywood')),
    ('https://wzdbqcgtygvmtfdajvio.supabase.co/storage/v1/object/public/CinemaAppPhotos/vsfcbekllchxbgylfrta/images/movies/OnceUpon/nmsutFaFnlY1N85mPDt0r4fWynL.jpg', false,
     (SELECT id FROM movies WHERE title = 'Once Upon a Time... in Hollywood')),
    ('https://wzdbqcgtygvmtfdajvio.supabase.co/storage/v1/object/public/CinemaAppPhotos/vsfcbekllchxbgylfrta/images/movies/OnceUpon/oRiUKwDpcqDdoLwPoA4FIRh3hqY.jpg', false,
     (SELECT id FROM movies WHERE title = 'Once Upon a Time... in Hollywood')),
    ('https://wzdbqcgtygvmtfdajvio.supabase.co/storage/v1/object/public/CinemaAppPhotos/vsfcbekllchxbgylfrta/images/movies/OnceUpon/vm8C7lAob4hSn8MvHGa9RBLy7rR.jpg', false,
     (SELECT id FROM movies WHERE title = 'Once Upon a Time... in Hollywood')),

    ('https://wzdbqcgtygvmtfdajvio.supabase.co/storage/v1/object/public/CinemaAppPhotos/vsfcbekllchxbgylfrta/images/movies/Minecraft/4MWc9Ur80Wo0B1fVVTnV0CoSh6A.jpg', false,
     (SELECT id FROM movies WHERE title = 'Minecraft')),
    ('https://wzdbqcgtygvmtfdajvio.supabase.co/storage/v1/object/public/CinemaAppPhotos/vsfcbekllchxbgylfrta/images/movies/Minecraft/56lv8d5yst1SBhw1uR3iGFd1R43.jpg', false,
     (SELECT id FROM movies WHERE title = 'Minecraft')),
    ('https://wzdbqcgtygvmtfdajvio.supabase.co/storage/v1/object/public/CinemaAppPhotos/vsfcbekllchxbgylfrta/images/movies/Minecraft/lEkq2xPYtvEGx2iKkClN3p5uxFQ.jpg', false,
     (SELECT id FROM movies WHERE title = 'Minecraft')),
    ('https://wzdbqcgtygvmtfdajvio.supabase.co/storage/v1/object/public/CinemaAppPhotos/vsfcbekllchxbgylfrta/images/movies/Minecraft/ws2UKX5dtQlK6sJWbVaikCOJbxD.jpg', false,
     (SELECT id FROM movies WHERE title = 'Minecraft')),

    ('https://wzdbqcgtygvmtfdajvio.supabase.co/storage/v1/object/public/CinemaAppPhotos/vsfcbekllchxbgylfrta/images/movies/CaptainAmericaBraveNewWorld/4ybBpFNwTQCbBewWrpO2YFNWRuB.jpg', false,
     (SELECT id FROM movies WHERE title = 'Captain America: Brave New World')),
    ('https://wzdbqcgtygvmtfdajvio.supabase.co/storage/v1/object/public/CinemaAppPhotos/vsfcbekllchxbgylfrta/images/movies/CaptainAmericaBraveNewWorld/eJLTpgUAFkx165LuUoQqQGyN5Wp.jpg', false,
     (SELECT id FROM movies WHERE title = 'Captain America: Brave New World')),
    ('https://wzdbqcgtygvmtfdajvio.supabase.co/storage/v1/object/public/CinemaAppPhotos/vsfcbekllchxbgylfrta/images/movies/CaptainAmericaBraveNewWorld/ncTtBRGnohOCMKfVuu3AfzaL1xE.jpg', false,
     (SELECT id FROM movies WHERE title = 'Captain America: Brave New World')),
    ('https://wzdbqcgtygvmtfdajvio.supabase.co/storage/v1/object/public/CinemaAppPhotos/vsfcbekllchxbgylfrta/images/movies/CaptainAmericaBraveNewWorld/qfAfE5auxsuxhxPpnETRAyTP5ff.jpg', false,
     (SELECT id FROM movies WHERE title = 'Captain America: Brave New World')),

    ('https://wzdbqcgtygvmtfdajvio.supabase.co/storage/v1/object/public/CinemaAppPhotos/vsfcbekllchxbgylfrta/images/movies/TheUnion/ADJon1zAvcParV7A1e6q6z0KVQ.jpg', false,
     (SELECT id FROM movies WHERE title = 'The Union')),
    ('https://wzdbqcgtygvmtfdajvio.supabase.co/storage/v1/object/public/CinemaAppPhotos/vsfcbekllchxbgylfrta/images/movies/TheUnion/dqsWbl7aubfUn6OqmkmXPISj2W6.jpg', false,
     (SELECT id FROM movies WHERE title = 'The Union')),
    ('https://wzdbqcgtygvmtfdajvio.supabase.co/storage/v1/object/public/CinemaAppPhotos/vsfcbekllchxbgylfrta/images/movies/TheUnion/mFhihsHSoyIqZbK7IgspWwq23ww.jpg', false,
     (SELECT id FROM movies WHERE title = 'The Union')),
    ('https://wzdbqcgtygvmtfdajvio.supabase.co/storage/v1/object/public/CinemaAppPhotos/vsfcbekllchxbgylfrta/images/movies/TheUnion/vRHOXQhTrlWp0Hzr1b5Qn2Fa3bx.jpg', false,
     (SELECT id FROM movies WHERE title = 'The Union')),

    ('https://wzdbqcgtygvmtfdajvio.supabase.co/storage/v1/object/public/CinemaAppPhotos/vsfcbekllchxbgylfrta/images/movies/GladiatorII/8mjYwWT50GkRrrRdyHzJorfEfcl.jpg', false,
     (SELECT id FROM movies WHERE title = 'Gladiator II')),
    ('https://wzdbqcgtygvmtfdajvio.supabase.co/storage/v1/object/public/CinemaAppPhotos/vsfcbekllchxbgylfrta/images/movies/GladiatorII/A4SDLzUM9RJVdQc3gWOX4epGLM7.jpg', false,
     (SELECT id FROM movies WHERE title = 'Gladiator II')),
    ('https://wzdbqcgtygvmtfdajvio.supabase.co/storage/v1/object/public/CinemaAppPhotos/vsfcbekllchxbgylfrta/images/movies/GladiatorII/bHeUgZKqduubnNl8GshjrpHS9lF.jpg', false,
     (SELECT id FROM movies WHERE title = 'Gladiator II')),
    ('https://wzdbqcgtygvmtfdajvio.supabase.co/storage/v1/object/public/CinemaAppPhotos/vsfcbekllchxbgylfrta/images/movies/GladiatorII/xGv28mcf8vdFttD0KgI5GnDDlkG.jpg', false,
     (SELECT id FROM movies WHERE title = 'Gladiator II')),

    ('https://wzdbqcgtygvmtfdajvio.supabase.co/storage/v1/object/public/CinemaAppPhotos/vsfcbekllchxbgylfrta/images/movies/BlinkTwice/11xVvX1H7alRDfGHztA4lNvocDh.jpg', false,
     (SELECT id FROM movies WHERE title = 'Blink Twice')),
    ('https://wzdbqcgtygvmtfdajvio.supabase.co/storage/v1/object/public/CinemaAppPhotos/vsfcbekllchxbgylfrta/images/movies/BlinkTwice/h6K9vwhbogdqXMxIpFpqKS9bEjQ.jpg', false,
     (SELECT id FROM movies WHERE title = 'Blink Twice')),
    ('https://wzdbqcgtygvmtfdajvio.supabase.co/storage/v1/object/public/CinemaAppPhotos/vsfcbekllchxbgylfrta/images/movies/BlinkTwice/yUJpsoVT51seW9YG3jrRh9JS5S0.jpg', false,
     (SELECT id FROM movies WHERE title = 'Blink Twice')),
    ('https://wzdbqcgtygvmtfdajvio.supabase.co/storage/v1/object/public/CinemaAppPhotos/vsfcbekllchxbgylfrta/images/movies/BlinkTwice/zQuOiqlktwgR64WW07PFWpjxWGs.jpg', false,
     (SELECT id FROM movies WHERE title = 'Blink Twice')),

    ('https://wzdbqcgtygvmtfdajvio.supabase.co/storage/v1/object/public/CinemaAppPhotos/vsfcbekllchxbgylfrta/images/movies/Wicked/830sdPfXpyizgm05HR3LR6vFJrL.jpg', false,
     (SELECT id FROM movies WHERE title = 'Wicked')),
    ('https://wzdbqcgtygvmtfdajvio.supabase.co/storage/v1/object/public/CinemaAppPhotos/vsfcbekllchxbgylfrta/images/movies/Wicked/jTOeWjamUKGxWVUO1TMZXqQUarw.jpg', false,
     (SELECT id FROM movies WHERE title = 'Wicked')),
    ('https://wzdbqcgtygvmtfdajvio.supabase.co/storage/v1/object/public/CinemaAppPhotos/vsfcbekllchxbgylfrta/images/movies/Wicked/k4xavRmJUzf3M2LRDxhlPq8R6zy.jpg', false,
     (SELECT id FROM movies WHERE title = 'Wicked')),
    ('https://wzdbqcgtygvmtfdajvio.supabase.co/storage/v1/object/public/CinemaAppPhotos/vsfcbekllchxbgylfrta/images/movies/Wicked/uDjYG4ODYetiNuRaopvLvRq0RuO.jpg', false,
     (SELECT id FROM movies WHERE title = 'Wicked'));
